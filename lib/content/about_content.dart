class AboutContent {
  static const List<Map<String, String>> sections = [
    ...
    },
    {
      ...
      'body':
          'Take action beyond your daily habits by joining environmental events near you. '
          'You can also create your own events and motivate others to make a difference.',
    },
  ];
}
